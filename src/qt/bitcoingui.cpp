    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Satoshi's Bitcoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(TextColorIcon(":/icons/about"), tr("&About Satoshi's Bitcoin"), this);
    aboutAction->setStatusTip(tr("Show information about Satoshi's Bitcoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Satoshi's Bitcoin"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Satoshi's Bitcoin help message to get a list with possible Bitcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Satoshi's Bitcoin client") + " " + networkStyle->getTitleAddText();
